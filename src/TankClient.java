...
public class TankClient extends Frame implements ActionListener {
	...
	public void update(Graphics g) {//更新屏幕窗体
	...
	public void framPaint(Graphics g) {
		...
		for (int i = 0; i < homeWall.size(); i++) { // 家里的坦克撞到自己家的墙
	...
	public TankClient() {//初始化
		...
		this
				.setTitle("坦克大战——(重新开始：R键  开火：F键)   姓名：邵建欣            班级：15软件1班          学号：1504220130");
